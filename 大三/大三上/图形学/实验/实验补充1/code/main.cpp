...
// #endif
	...
	modelView = glm::rotate(modelView, glm::radians(Theta[UpperArm]),
	...
	modelView = glm::rotate(modelView, glm::radians(Theta[LowerArm]),
		glm::vec3(0.0, 0.0, 1.0));
	// 绘制小臂	
	lower_arm(modelView);
...
int main(int argc, char **argv)
{
	...
	// 配置窗口属性
	GLFWwindow* window = glfwCreateWindow(600, 600, "2022152021_王培鸿_实验补充1", NULL, NULL);
	if (window == NULL)
	{
