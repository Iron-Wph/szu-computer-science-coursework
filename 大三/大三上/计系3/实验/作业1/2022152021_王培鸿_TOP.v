...
module ALU(	// src/main/scala/ALU.scala:4:7
  ...
  wire [18:0] _io_out_T_10 = 19'h3 >> io_b;	// src/main/scala/ALU.scala:24:25
  assign io_out =
    io_op == 4'h0
      ? io_b + 4'h3
      : (io_op[0] ? 4'h3 * io_b : 4'h0) | (io_op[1] ? io_b | 4'h3 : 4'h0)
        | (io_op[2] ? ~4'h3 : 4'h0) | (io_op[3] ? _io_out_T_10[3:0] : 4'h0);
endmodule
