...
class KnowledgeBaseManager:
    ...
    def _initialize_vectorstore(self):
        ...
        raw_documents = self.doc_processor.load_directory(self.knowledge_base_dir,existing_sources=existing_sources)
        # split_docs = self.doc_processor.split_documents(raw_documents)
