...
class Discriminator(keras.Model):
    def __init__(self, name='Discriminator', dense=32, activation='leaky_relu', **kwargs):
        ...
        # 修改 Downsample 层的参数
        self.downsample1 = Downsample(32, name='Downsample_64')  ## (bs, 64, 64, 32)
        self.downsample2 = Downsample(64, name='Downsample_32')  ## (bs, 32, 32, 64)
        self.downsample3 = Downsample(128, name='Downsample_16')  ## (bs, 16, 16, 128)
        self.downsample4 = Downsample(128, name='Downsample_8')  ## (bs, 8, 8, 128)

        self.zeropad = layers.ZeroPadding2D(name='Zero_Padding')
        self.downsample5 = Downsample(256, strides=(1, 1), kernel_size=(2, 2),
                                      name='Downsample_stride_1')  ## (bs, 8, 8, 256)
